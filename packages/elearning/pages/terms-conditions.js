                                    ...
                                    <div className='privacy-policy-content'>
                                        <p>
                                            <i>
                                                {t('terms-condition-i', {
                                                    defaultValue:
                                                        'This Terms & Conditions was last updated on March 22, 2023.',
                                                })}
                                            </i>
                                        </p>
                                        <h3>
                                            {t('terms-condition-h3', {
                                                defaultValue:
                                                    '1. What Data We Get',
                                            })}
                                        </h3>
                                        ...
                                        <h3>
                                            {t('terms-condition-h32', {
                                                defaultValue:
                                                    '2. Data You Provide to Us',
                                            })}
                                        </h3>
                                        <p>
                                            {t('terms-condition-p2', {
                                                defaultValue:
                                                    'We may collect different data from or about you depending on how you use the Services. Below are some examples to help you better understand the data we collect.',
                                            })}
                                        </p>
                                        <h3>
                                            {t('terms-condition-h33', {
                                                defaultValue:
                                                    '3. How We Get Data About You',
                                            })}
                                        </h3>
                                        <p>
                                            {t('terms-condition-p3', {
                                                defaultValue:
                                        ...
                                        <ol>
                                            <li>
                                                {t('terms-condition-li1', {
                                                    defaultValue:
                                                        'Responding to your questions and concerns;',
                                                })}
                                            </li>
                                            <li>
                                                {t('terms-condition-li2', {
                                                    defaultValue:
                                        ...
                                        <h3>
                                            {t('terms-condition-h35', {
                                                defaultValue:
                                                    '5. Your Choices About the Use of Your Data',
                                            })}
                                        </h3>
                                        <p>
                                            {t('terms-condition-p4', {
                                                defaultValue:
                                        ...
                                        <h3>
                                            {t('terms-condition-h36', {
                                                defaultValue:
                                                    '6. Our Policy Concerning Children',
                                            })}
                                        </h3>
                                        <p>
                                            {t('terms-condition-p5', {
                                                defaultValue:
